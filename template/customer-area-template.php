            ...
            <form method="POST" id="personal-form" class="m-0">
                ...
                <fieldset id="personal_fieldset" class="px-0" disabled>
                    ...
                    <div id="form-new-password" class="form-group row text-center d-none">
                        ...
                        <input type="password" class="form-control col-6" id="new_password"
                    ...
                    <div class="form-group row text-center">
                        ...
                        <input type="number" class="form-control col-6" id="postal_code"
                        value="<?php echo $info["Postal_code"] ?>" name="postal_code" required/>
                    </div>
                    <div class="form-group row text-center">
                        <label for="birth_date" class="col-5">Birth date</label>
                        <input type="date" class="form-control col-6" id="birth_date"
                        value="<?php echo $info["Birth_date"] ?>" name="birth_date" required/>
                    </div>
                    <?php endforeach;?>
                </fieldset>
                ...
                <form method="POST" class="col-10 offset-1 px-3 border">
                    <fieldset class="px-0 mb-2">
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <input name="owner" type="text" class="form-control col-10 offset-1" id="owner" required/>
                        </div>
                        <div class="form-group row">
                            <label for="add_number" class="col-10 offset-1">Number</label>
                            <input type="number" name="add_number" class="form-control col-10 offset-1" id="add_number" required/>
                        </div>
                        <div class="form-group row">
                            <label for="exp_date" class="col-10 offset-1">Expire date</label>
                            <input type="date" class="form-control col-10 offset-1" id="exp_date" required/>
                        </div>
