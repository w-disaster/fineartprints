...
<div class="container-fluid bg-white p-0 m-0">
    ...
    <div class="row m-0 parallax"></div>

    <div class="row mx-0 my-4"> 
        <h1 class="col-12 text-center display-4">About us</h1> 
    </div>
    ...
    <div class="row m-4 px-5">
        ...
        <div class="col-12 p-0 m-0">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner border rounded p-3">
                    <div class="carousel-item active">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-7 align-self-center">
                                    <img class="img-fluid rounded" src="./upload/Damien-Hirst.jpeg" alt="First slide">
                                </div> 
                                    ...
                                    <h2 class="d-none">description</h2> 
                                        <ul>
                                            ...
                                            <li>Select the printing technique. for example:
                                                <ul>
                                                    <li>Print on Artist's Canvas</li>
                                                    <li>Print on Varnished Canvas</li>
                                                    <li>Print on Craft Paper</li>
                                                    <li>Print on Photographic Paper</li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </section>
                    ...
                    <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-7 align-self-center">
                                    <img class="d-block img-fluid rounded" src="./upload/sofa.jpeg" alt="First slide">
                                </div> 
                                <div class="col-12 col-md-5 align-self-center my-3">
                                    <p class="d-block lead text-center">
                                        Select the ideal frame and passpartout for your room
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-7 align-center">
                                    <img class="d-block img-fluid rounded" src="./upload/carrier-express.jpeg" alt="First slide">
                                </div> 
                                <div class="col-12 col-md-5 align-self-center my-3">
                                    <p class="d-block lead text-center">
