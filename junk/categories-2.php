...
<div class="row border mx-0 mb-4 px-5 py-4 bg-white w-100 justify-content-center">
    <h2 class="mt-3 mb-3 text-center">Categories</h2>
</div>

<div class="row border m-0 px-5 py-4 bg-white">
    <div class="col-6 col-md-3 d-flex align-items-center py-5">
        <a href="#">
            <img class="img-fluid" src="upload/film1.webp" alt="" />
        </a>
        <a href="#" class="middle text-white bg-dark">
            <h3>Film</h3>
        </a>
    </div>
    <div class="col-6 col-md-3 d-flex align-items-center py-5">
...
<div class="row border m-0 mt-4 mb-2 px-5 py-4 bg-white">
    <div class="col-6 col-md-3 d-flex align-items-center py-5">
        <a href="#">
