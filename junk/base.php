...
<body>
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link navbar-brand" href="about-us.html"><img
                  src="upload/icons/person-circle.svg" alt="your profile" width="32" height="32"></a>
            </li>
            <li class="nav-item"><a class="nav-link navbar-brand" href="about-us.html"><img src="upload/icons/bag.svg"
  ...
  <div class="subtle-pattern flex-grow-1">
    <div class="subtle-pattern container-fluid bg-white flex-flow-row-wrap">
