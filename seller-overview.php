...
<div class="row">
  <div class="col-md-3">
    <aside class="bg-white sidebar container shadow-sm my-4 p-4">
      ...
      <a href="seller-overview.html" class="list-group-item list-group-item-action bg-white">Overview</a>
  ...
  <div class="col-md-9">
    <div class="container pb-5 px-4 my-4">
      <div class="row">
      ...
      <div class="row">
        <div class="container mt-4 px-4 card-group">
