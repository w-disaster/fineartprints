            ...
            <main class="h-100 container-fluid px-0">   
                <div class="row mx-0 mt-3">
                    <ul class="nav nav-pills col-10 col-md-5 offset-1 offset-md-1">
                        <li class="nav-item col-5 col-md-5 text-center p-0">
                          <a class="nav-link" href="customer-area.html">Profile</a>
                        </li>
                        <li class="nav-item col-5 col-md-5 text-center p-0">
                ...
                <div class="col-10 col-md-10 offset-1 offset-md-1 px-0 bg-white border mb-4">
                    <ul class="nav col-12 col-md-12 p-0">
                        <h2 class="offset-md-1 offset-1 my-3">My orders</h2>
                            ...
                            <div class="row p-0 col-12 col-md-12 ml-1 d-flex align-items-center">
                                <div class="col-10 offset-1 col-md-10 offset-md-1 bg-primary text-white p-0">
                                    <ul class="nav text-center">
                                        <li class="nav-item col-4 col-md-4 m-0 py-2">Ship date: 25/12/2020</li>
                                        <li class="nav-item col-4 col-md-4 m-0 py-2">Total: 40€</li>
                                        <li class="nav-item col-4 col-md-4 m-0 py-0"><a class="nav-link text-white" href="#">Details</a></li>
                                    </ul>
                                </div>
                            </div>
                    <div class="row col-md-12 p-0 ml-1">
                        <ul class="nav col-10 offset-1 offset-md-1 col-md-10 bg-light">
                            <li class="nav-item">
                                <ul class="pl-4 border-left">
                                    <li class="row border-bottom border-right">
                                        <div class="col-10 offset-1 offset-md-0 col-md-4 p-0 my-3 text-center">
                                            <img class="img-fluid" src="./upload/abstract2.webp" style="max-height:200px" alt=""/>
                                        </div>
                                        <div class="col-12 col-md-8 my-3">
                                            <a class="col-12 col-md-12" href="#">Product name</a>
                                    ...
                                    <li class="row border-bottom border-right">
                                        <div class="col-12 offset-0 offset-md-0 col-md-4 p-0 my-3 text-center">
                                            <img class="img-fluid" src="./upload/img6.jpeg" style="max-height:200px" alt=""/>
                                        </div>
                                        <div class="col-12 col-md-8 my-3">
                                            <a class="col-12 col-md-12" href="#">Product name</a>
                                            <p class="col-12 col-md-12">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe atque reiciendis dolor nemo iste. Accusamus, porro quis aliquid at accusantium molestias eligendi assumenda corporis et ea? Cum enim ut doloremque.</p>
                                            <p class="col-12 col-md-12">Price: 15€</p>
                                        </div>
                                    </li>
                                </ul>
                            </li>
